...
def count_sentiment_score_by_years(path_data: str, path_positive: str, path_negative: str) -> dict[int, int]:
...
def main():
    scores = count_sentiment_score_by_years("./data/trump_tweets.txt", "./data/positive-words.txt", "./data/negative-words.txt")
    print(scores)
