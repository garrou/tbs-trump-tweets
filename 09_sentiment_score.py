...
def count_score(path_data: str, path_stop: str, path_positive: str, path_negative: str) -> int:
...
def main():
    score = count_score("./data/trump_tweets.txt", "./data/stop-words.txt", "./data/positive-words.txt", "./data/negative-words.txt")
